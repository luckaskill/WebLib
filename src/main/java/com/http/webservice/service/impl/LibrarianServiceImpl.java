...
public class LibrarianServiceImpl implements LibrarianService {
    ...
    private TurnoverDAO turnover;

    public LibrarianServiceImpl(DAOManager daoManager) {
        this.libraryDAO = daoManager.getLibraryDAO();
        this.turnover = daoManager.getTurnoverDAO();
    }
