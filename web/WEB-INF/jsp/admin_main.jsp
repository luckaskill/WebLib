...
<c:if test="${requestScope.booksControllerView}">
    <div align="center" style="width: 100%">
        <form action="controller" method="post" style="background-color: #000000bd; width: 22%;">
            ...
            <div align="right" class="editBookFields">
                    ${locale_coast}:
                <input type="text" name="coast" value="10.0"/>
            </div>
            <div align="right" class="editBookFields">
                    ${locale_raring}:
            ...
            <div align="right" class="editBookFields">
                    ${locale_rent_coast}:
                <input type="text" name="rent_coast" value="5"/>
            </div>
...
<c:if test="${requestScope.editBookPanelView}">
    <div align="center" style="width: 100%">
        <form action="controller" method="post" style="background-color: #000000bd; width: 22%;">
            ...
            <div align="right" class="editBookFields">
                    ${locale_coast}
                <input type="text" name="coast" value="${requestScope.coast}"/>
            </div>
            <div align="right" class="editBookFields">
                    ${locale_raring}:
            ...
            <div align="right" class="editBookFields">
                    ${locale_rent_coast}:
                <input type="text" name="rentCoast" value="${requestScope.rentCoast}"/>
            </div>
